...
<div class="container darkbg clearfix">
	<div id="headercont" class="clearfix">
		...
		<div id="headerright">
            <p><span><img src="imagenes/twitterliteratura2.jpg" alt=""></span></p>
         <!--<p><span>Email:</span> info@yourdomain.co.uk</p>-->
		</div>
	</div>
</div>
    ...
    <div id="menucont" class="clearfix">
        <div class="menu">
            <ul>
                ...
                <li><a href="../reglas.php"><span>Reglas de Ortografia</span></a></li>
                <li><a title="" href="../obra.php"><span>Obras</span></a>
	
                </li>
                <li><a title="" href="../contactos.php"><span>contacto</span></a></li>
